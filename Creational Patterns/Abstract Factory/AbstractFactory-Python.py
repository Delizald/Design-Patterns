...
class ConcreteFactory1(AbstractFactory):
    """
    Implement operations to create the product objects
    """
...
class ConcreteFactory2(AbstractFactory):
    """
    Implement the operations to create product objects
    """
...
class AbstractProductB(metaclass=abc.ABCMeta):
    """
    Delcare an interface for a type of product
    """
...
class ConcreteProductB1(AbstractProductB):
    """
    Define a product object to be crated by the corresponding concrete factory.
    Implement the AbstractProduct interface
    """
